<template><h1 id="routing" tabindex="-1"><a class="header-anchor" href="#routing" aria-hidden="true">#</a> Routing</h1>
...
<p><a href="https://overreacted.io/a-complete-guide-to-useeffect/" target="_blank" rel="noopener noreferrer">An in-depth guide to the use effect hook. A fantastic blog post by  Dan Abramov - a react core team member.<OutboundLink/></a>(optional)</p>
</div>
<p>This week is going to be particularly interesting You are going to be learning how to implement routing into your application.  This will allow us to create the effect of having multiple pages in our single page application.</p>
...
<p>Structuring an ever-evolving React application can be a complex undertaking. The complexity comes from the fact there is no right or wrong way to do things - React is very unopinionated.</p>
...
<p>The above views can be represented in the following file structure:</p>
...
<h2 id="task-3-restructuring-our-application" tabindex="-1"><a class="header-anchor" href="#task-3-restructuring-our-application" aria-hidden="true">#</a> Task 3 - Restructuring our application</h2>
...
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<h2 id="task-2-installing-and-configuring-the-react-router" tabindex="-1"><a class="header-anchor" href="#task-2-installing-and-configuring-the-react-router" aria-hidden="true">#</a> Task 2 - Installing and configuring the react-router</h2>
...
<li>
<p>Also, import all of your views into your App component.</p>
</li>
<li>
<p>We can now add routes as follows:</p>
</li>
</ul>
...
<h2 id="further-routing" tabindex="-1"><a class="header-anchor" href="#further-routing" aria-hidden="true">#</a> Further Routing</h2>
<h3 id="dealing-with-links" tabindex="-1"><a class="header-anchor" href="#dealing-with-links" aria-hidden="true">#</a> Dealing With Links</h3>
<p>Consider our menu that currently lives in <code>src/Components/Header.js</code>. Notice how our menu links are not operational. React-router provides us with a <code>&lt;Link&gt;</code> component, which can be used in replacement of traditional <code>&lt;a&gt;</code> tags. Let's set up some links:</p>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<h2 id="task-3-setting-up-links" tabindex="-1"><a class="header-anchor" href="#task-3-setting-up-links" aria-hidden="true">#</a> Task 3 - Setting Up Links</h2>
<ul>
<li>Within <code>src/Components/Header.js</code> import <code>react-router</code>'s <code>&lt;Link&gt;</code> component:</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span>Link<span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">"react-router-dom"</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><ul>
<li>We can now set up our links as follows:</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code> <span class="token operator">&lt;</span>Link to<span class="token operator">=</span><span class="token string">"/"</span><span class="token operator">></span> Dash <span class="token operator">&lt;</span><span class="token operator">/</span>Link<span class="token operator">></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><ul>
<li>Complete this task by setting up a link for  profile</li>
</ul>
</div>
<h2 id="logic-base-on-the-route" tabindex="-1"><a class="header-anchor" href="#logic-base-on-the-route" aria-hidden="true">#</a> Logic base on the route</h2>
...
<h2 id="task-4-using-the-react-router-hooks" tabindex="-1"><a class="header-anchor" href="#task-4-using-the-react-router-hooks" aria-hidden="true">#</a> Task 4 - Using the react-router hooks</h2>
...
<li>The current location is now avalible to us in <code>location.pathname</code></li>
<li>Can you use location to highlight the active link? Do this to complete the task
:::</li>
</ul>
<h2 id="further-react-hooks" tabindex="-1"><a class="header-anchor" href="#further-react-hooks" aria-hidden="true">#</a> Further React Hooks</h2>
<p>Currently, when we change location the menu remains open. From a usability perspective, this is not ideal - since the user has completed their required action we should close the menu. To achieve this functionality we need to be able to listen to the location and act when it changes. The <code>useEffect</code> react hook allows us to do this.</p>
<p>Remember, <a href="https://reactjs.org/docs/hooks-effect.html" target="_blank" rel="noopener noreferrer">&quot;Hooks are a new addition in React 16.8. They let you use state and other React features without writing a class.&quot;<OutboundLink/></a>.</p>
<p>We can use the <code>useEffect</code> hook to run an effect whenever the state of our component changes.  For now, you can just use this hook in a rote learning fashion. However, hooks, specifically the useEffect, are very powerful and I recommend conducting research in your own time (<a href="https://overreacted.io/a-complete-guide-to-useeffect/" target="_blank" rel="noopener noreferrer">read<OutboundLink/></a>, <a href="https://reactjs.org/docs/hooks-effect.html" target="_blank" rel="noopener noreferrer">read<OutboundLink/></a>).</p>
<p>Below is an example of a useEffect  hook:</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><p>As I said, we, unfortunately, do not have the time to explore effect hooks in-depth. However, we can briefly touch on the above example.</p>
<p><code>UseEffect</code> is a function that takes in, as an argument, a function and an optional array. The function is the effect and will be run every time the component state updates. The second optional argument - the array - limits the effect to run only on specific state updates. <strong>As such, in the above example, the effect will only run when the count state updates</strong>.</p>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<h2 id="task-5-using-useeffect" tabindex="-1"><a class="header-anchor" href="#task-5-using-useeffect" aria-hidden="true">#</a> Task 5 - Using UseEffect</h2>
<p>Can you use the useEffect hook within your menu component to watch the <code>location</code> variable?  When the location changes you should close the menu?</p>
</div>
<h2 id="home-study" tabindex="-1"><a class="header-anchor" href="#home-study" aria-hidden="true">#</a> Home Study</h2>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<h2 id="task-7-create-a-404-page" tabindex="-1"><a class="header-anchor" href="#task-7-create-a-404-page" aria-hidden="true">#</a> Task 7 - Create a 404 page</h2>
<p>Can you work out how to set up a 404 page if a route does not exist?</p>
</div>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<h2 id="task-8-conditional-rendering" tabindex="-1"><a class="header-anchor" href="#task-8-conditional-rendering" aria-hidden="true">#</a> Task  8 - Conditional Rendering</h2>
<p>Work out how to use the <code>useLocation</code> hook to hide the <code>&lt;Header /&gt;</code> on the login/sign up page</p>
</div>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<h2 id="task-9" tabindex="-1"><a class="header-anchor" href="#task-9" aria-hidden="true">#</a> Task  9</h2>
<p>Can you hoist the menu state up to app? If you do this you should be able to add the functionality to close the menu if a user clicks away from it on the main part of the application.</p>
</div>
</template>
