<template><!-- # Web Application Development Notes 2021
...
- **React**: React is currently the most popular JavaScript framework. React developer are in high demand, and contract rates can reach as high as £700 per-day! Demand and money aside, React is an incredibly powerful framework and a joy to work with.
